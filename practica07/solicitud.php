...
<head>
    ...
    <meta name="description" content="Página de solicitud de impresión de álbum para la web PI - Pictures & Images">
    ...
    <title>PI - Solicitud de álbum</title>
</head>
<body>
    <header id="cabecera">
        <figure>
                    ...
                    <form id="formulario" method="POST">
                        ...
                        <div>
                            ...
                            <datalist id="countries">
                                ...
                                <option value="República Sudafricana"></option>
